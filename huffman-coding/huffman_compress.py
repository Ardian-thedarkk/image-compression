...
import adaptive_huffman_coding
...
class huffman_compress:
    ...
    def compress(self):
        ...
        bitout  = adaptive_huffman_coding.bitOutStream(self.string_path)

        encoder = adaptive_huffman_coding.encoder(bitout)
...
def main(argv):
    ...
    compressor = huffman_compress(image_path, output_path)
    compressor.compress()
    compressor.write()
